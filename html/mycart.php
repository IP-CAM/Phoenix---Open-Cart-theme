						...
						<div class="col-main">
							<div class="cart">
								<div class="page-title title">
									<p class="title1">Shopping</p>
									<h3 class="title2">Shopping Cart</h3>
								</div>
								<form method="post" action="http://ecoblueocean.com/ecoclub/demo/tv_phoenix/index.php/checkout/cart/updatePost/">
										...
										<table class="data-table cart-table" id="shopping-cart-table">
											...
											<thead>
												<tr class="first last">
													...
													<th rowspan="1"></th>
													<th class="a-center" rowspan="1"><span class="nobr">Move to Wishlist</span></th>
											...
											<tfoot>
												<tr class="first last">
													<td class="a-right last" colspan="50"><button onclick="setLocation('http://ecoblueocean.com/ecoclub/demo/tv_phoenix/index.php/')" class="button btn-continue" title="Continue Shopping" type="button"><span><span>Continue Shopping</span></span></button>
                            ...
                            <![endif]--></td>
											...
											<tbody>
												<tr class="first last odd">
													<td><a class="product-image" title="Duis Pulvinar Pulvinar" href="http://ecoblueocean.com/ecoclub/demo/tv_phoenix/index.php/fusce-aliquam-388.html"><img alt="Duis Pulvinar Pulvinar" src="http://ecoblueocean.com/ecoclub/demo/tv_phoenix/media/catalog/product/cache/1/thumbnail/75x75/9df78eab33525d08d6e5fb8d27136e95/p/h/phoenix-home-m_03.jpg"></a></td>
													<td><h2 class="product-name"> <a href="http://ecoblueocean.com/ecoclub/demo/tv_phoenix/index.php/fusce-aliquam-388.html">Duis Pulvinar Pulvinar</a> </h2></td>
													<td class="a-center"><a title="Edit item parameters" href="http://ecoblueocean.com/ecoclub/demo/tv_phoenix/index.php/checkout/cart/configure/id/57/">Edit</a></td>
													<td class="a-center"><a class="link-wishlist use-ajax" href="http://ecoblueocean.com/ecoclub/demo/tv_phoenix/index.php/wishlist/index/fromcart/item/57/" rel="tooltip" data-original-title="">Move</a></td>
													<td class="a-right"><span class="cart-price"> <span class="price">$250.00</span> </span></td>
													<!-- inclusive price starts here -->
													<td class="a-center"><input maxlength="12" class="input-text qty" title="Qty" size="4" value="1" name="cart[57][qty]"></td>
													
													<!--Sub total starts here -->
													<td class="a-right"><span class="cart-price"> <span class="price">$250.00</span> </span></td>
													<td class="a-center last"><a class="btn-remove btn-remove2" title="Remove item" href="http://ecoblueocean.com/ecoclub/demo/tv_phoenix/index.php/checkout/cart/delete/id/57/uenc/aHR0cDovL2Vjb2JsdWVvY2Vhbi5jb20vZWNvY2x1Yi9kZW1vL3R2X3Bob2VuaXgvaW5kZXgucGhwL2NoZWNrb3V0L2NhcnQv/">Remove item</a></td>
												</tr>
											</tbody>
										</table>
								...
								<div class="cart-collaterals row">
									<div class="col-1 col-xs-12 col-sm-4"> </div>
									<div class="col-2 col-xs-12 col-sm-4">
										<form method="post" action="http://ecoblueocean.com/ecoclub/demo/tv_phoenix/index.php/checkout/cart/couponPost/" id="discount-coupon-form">
											<div class="discount">
...
//]]&gt;
										...
										<div class="shipping">
											...
											<div class="shipping-form">
												<form id="shipping-zip-form" method="post" action="http://ecoblueocean.com/ecoclub/demo/tv_phoenix/index.php/checkout/cart/estimatePost/">
											...
											<table id="shopping-cart-totals-table">
												...
												<tfoot>
													<tr>
														...
														<td class="a-right" style=""><strong><span class="price">$250.00</span></strong></td>
													</tr>
												</tfoot>
												<tbody>
													<tr>
														<td colspan="1" class="a-right" style=""> Subtotal </td>
														<td class="a-right" style=""><span class="price">$250.00</span></td>
													</tr>
												</tbody>
											</table>
											<ul class="checkout-types">
												<li>
													<button onclick="window.location='http://ecoblueocean.com/ecoclub/demo/tv_phoenix/index.php/checkout/onepage/';" class="button btn-proceed-checkout btn-checkout" title="Checkout" type="button"><span><span>Checkout</span></span></button>
												</li>
												<li><a title="Checkout with Multiple Addresses" href="http://ecoblueocean.com/ecoclub/demo/tv_phoenix/index.php/checkout/multishipping/">Checkout with Multiple Addresses</a> </li>
											</ul>
										</div>
									</div>
								</div>
